// Função para mostrar status do container e rolar até a seção
function showStatus() {
...
// Função para mostrar informações do sistema (Atualizada para 2026 e Multi-AZ)
function showInfo() {
...
☁️ Ambiente Cloud: AWS Multi-AZ (ALB + ASG)
